...
exp=output/3sat9/mdm-alpha0.25-gamma1-bs1024-lr3e-4-ep600-T20-`date "+%Y%m%d-%H%M%S"`
mkdir -p $exp

CUDA_VISIBLE_DEVICES=0 \
accelerate launch --multi_gpu --num_machines 1 --mixed_precision fp16 --main_process_port 20099 \
src/train_bash.py \
